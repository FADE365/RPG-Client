...
public class TargetHUD extends Module {
    ...
    public void onRender(RenderGameOverlayEvent e) {
        if (!e.getType().equals(e.getType().TEXT)) {
            ...
            final float x = (float) (scaledWidth / 2.0 - posX);
            final float y = (float) (scaledWidth / 2.0 + posY);
            ...
            Gui.drawRect((int) (x + 166), (int) (y + 6.0f), (int) (x + 263.0f), (int) (y + 15.0f), new Color(40, 40, 40, 255).getRGB());
            Gui.drawRect((int) (x + 166.0f), (int) (y + 6.0f), (int) (x + 166.0f + this.healthBarWidth), (int) (y + 15.0f), new Color(0xFFC104B8, true).getRGB());

            Gui.drawRect((int) (x + 166.0f), (int) (y + 6.0f), (int) (x + 166.0f + hpWidth), (int) (y + 15.0f), new Color(0xFFC104B8, true).getRGB());

            mc.fontRenderer.drawStringWithShadow(healthStr, x + 128.0f + 46.0f - mc.fontRenderer.getStringWidth(healthStr) /  2.0f, y + 19.5f,  -1);
            mc.fontRenderer.drawStringWithShadow("\u2764", x + 128.0f + 46.0f + mc.fontRenderer.getStringWidth(healthStr), y + 19.5f, new Color(0xFFC104B8, true).getRGB());
